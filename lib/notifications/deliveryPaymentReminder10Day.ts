...
export type Render10DayDeliveryPaymentReminderParams = {
  contactName: string;
...
export function render10DayDeliveryPaymentReminderSms(
  params: Render10DayDeliveryPaymentReminderParams
) {
...
export function render10DayDeliveryPaymentReminderEmail(
  ...
  const htmlParts = [
    ...
    `<p>This is your final balance reminder.</p>`,
