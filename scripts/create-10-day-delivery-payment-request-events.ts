import { create10DayDeliveryPaymentRequestEvents } from "../lib/notifications/create10DayDeliveryPaymentRequestEvents";
...
async function main() {
  ...
  const summary = await create10DayDeliveryPaymentRequestEvents({ runDate, dryRun });
