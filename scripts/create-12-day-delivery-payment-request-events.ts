import { create12DayDeliveryPaymentRequestEvents } from "../lib/notifications/create12DayDeliveryPaymentRequestEvents";
...
async function main() {
  ...
  const summary = await create12DayDeliveryPaymentRequestEvents({ runDate, dryRun });
