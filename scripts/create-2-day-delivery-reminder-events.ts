import { create2DayDeliveryReminderEvents } from "../lib/notifications/create2DayDeliveryReminderEvents";
...
async function main() {
  ...
  const summary = await create2DayDeliveryReminderEvents({ runDate, dryRun });
